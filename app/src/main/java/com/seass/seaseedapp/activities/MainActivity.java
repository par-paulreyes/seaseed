                                    ...
                                    if (task.isSuccessful()) {
                                        ...
                                        if (document.exists()) {
                                            ...
                                            if ("Admin".equalsIgnoreCase(type)) {
                                                Log.d("DATABASE", "Admin role detected, redirecting to FreeDiverRegisterActivity");
                                                AppUtils.switchActivity(MainActivity.this, FreeDiverRegisterActivity.class, "ltr");
                                            }
                                            else if("Unregistered Free Diver".equalsIgnoreCase(type)) {
                                                Log.d("DATABASE", "Free Diver role detected, redirecting to UserSetupActivity");
                                                AppUtils.switchActivity(MainActivity.this, FreeDiverSetupActivity.class, "ltr");
                                            }else {
